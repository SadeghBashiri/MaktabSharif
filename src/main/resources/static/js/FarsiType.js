...
FarsiType.KeyObject = function(z,x) {
    ...
    GenerateStr = "";
    if (FarsiType.ShowChangeLangButton == 1) {
        GenerateStr = GenerateStr + "<input type='hidden' id=FarsiType_button_"+x+" style='border: none; background-color:darkblue; font-size:11; color:white; font-family:tahoma; padding: 1px; margin: 1px; width: auto; height: auto;' value='FA' />&nbsp;";
    }
    if (FarsiType.ChangeDir == 2) {
        GenerateStr = GenerateStr  + "<input type='hidden' id=FarsiType_ChangeDir_"+x+" style='border: none; background-color:darkblue; font-size:11; color:white; font-family:tahoma; padding: 1px; margin: 1px; width: auto; height: auto;' value='RTL' />"
    }
